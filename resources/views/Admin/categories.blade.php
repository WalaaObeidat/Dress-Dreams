...
<style>
    ...
    .Editb:hover{
        background-color: rgb(211, 95, 12);
        color:rgb(255, 255, 255);
    }
    .MoreDatails{
        cursor: pointer;
    ...
    .MoreDatails:hover{
        scale:1.1;
        color: rgb(211, 115, 25);
    }
</style>
<a href="{{route('categories.create')}}" type="button" class="btn btn-inline bg-gradient-success btn-sm" >Add categorie</a>
<div class="row">
    <div class="col-12">
      <div class="card">
