  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4" style="background: black">
    ...
    <a href="{{ route('dashboard') }}" class="brand-link">
      ...
      <span class="brand-text font-weight-light"> DressDreams</span>
    ...
    <nav class="mt-2">
      <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        <li class="">
          <a href="#" class="nav-link">
            <i></i>
            <a href=" {{route('logout')}}"> <button type="button" class="btn btn-block btn-outline-danger btn-sm" style="background: #a15118; color: white ; border:#a15118 ">Logout</button></a>
          </a>
        </li>
      </ul>
    </nav>
